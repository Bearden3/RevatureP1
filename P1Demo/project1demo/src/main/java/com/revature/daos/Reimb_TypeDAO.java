...
public class Reimb_TypeDAO implements Reimb_typeDAOInterface {
    @Override
    public Reimbursement_type getTypeById(int id) {
        ...
        try(Connection conn = ConnectionUtil.getConnection()){
            ...
            /*
              ...
              */
            String sql = "select * from reimb_type where reimb_type_id = ?;";
            ...
            while(rs.next()){
                ...
                Reimbursement_type reimb = new Reimbursement_type(
                        rs.getInt("reimb_type_id"),
                        rs.getString("reimb_types")
                );
                //This is just a CONSTRUCTOR that we opened up for the sake of cleaner code

                return reimb; //return the Role data to the user!!
            }
    ...
    @Override
    public boolean updateReimbType(String title, int salary) {
